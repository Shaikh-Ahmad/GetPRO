...
<div class="container register">
    <div class="row">
        ...
        <div class="col-md-9 register-right">
            ...
            <ul class="nav nav-tabs nav-justified ml-4"  id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">professional</a>
                </li>
                <li class="nav-item">
            ...
            <strong> <p class="" style="margin-left:630px">Choose a role</p></strong>
            
            <div class="tab-content" id="myTabContent">

                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <form method="POST" action="{{ route('register') }}" onsubmit="return confirm('Are you sure you want to Register as Professional?')">
                        @csrf
                ...
                <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <form method="POST" action="{{ route('register') }}" onsubmit="return confirm('Are you sure you want to Register as Client / Hirer ?')">
                        @csrf
